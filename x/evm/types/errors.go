...
const (
	codeErrInvalidState        = 2 // uint32(iota) + 2 // NOTE: code 1 is reserved for internal errors
	codeErrExecutionReverted   = 3 // IMPORTANT: Do not move this error as it complies with the JSON-RPC error standard
	codeErrChainConfigNotFound = 4
	codeErrInvalidChainConfig  = 5
	codeErrZeroAddress         = 6
	codeErrEmptyHash           = 7
	codeErrBloomNotFound       = 8
	codeErrTxReceiptNotFound   = 9
	codeErrCreateDisabled      = 10
	codeErrCallDisabled        = 11
	codeErrInvalidAmount       = 12
	codeErrInvalidGasPrice     = 13
	codeErrInvalidGasFee       = 14
	codeErrVMExecution         = 15
	codeErrInvalidRefund       = 16
	codeErrInconsistentGas     = 17
	codeErrInvalidGasCap       = 18
	codeErrInvalidBaseFee      = 19
	codeErrGasOverflow         = 20
	codeErrInvalidAccount      = 21
	codeErrInvalidGasLimit     = 22
...
var (
	...
	ErrABIPack   = errorsmod.Register(ModuleName, codeErrABIPack, "failed abi pack args")
	ErrABIUnpack = errorsmod.Register(ModuleName, codeErrABIUnpack, "failed abi unpack data")
)
