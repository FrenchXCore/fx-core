...
func (suite *ProposalTestSuite) TestRegisterERC20Proposal() {
	testCases := []struct {
		...
		// Valid tests
		{msg: "Register token pair - valid pair enabled", title: "test", description: "test desc", pair: types.TokenPair{Erc20Address: helpers.GenerateAddress().String(), Denom: "test", Enabled: true, ContractOwner: types.OWNER_MODULE}, expectPass: true},
		{msg: "Register token pair - valid pair dissabled", title: "test", description: "test desc", pair: types.TokenPair{Erc20Address: helpers.GenerateAddress().String(), Denom: "test", ContractOwner: types.OWNER_MODULE}, expectPass: true},
		// Missing params valid
		{msg: "Register token pair - invalid missing title ", title: "", description: "test desc", pair: types.TokenPair{Erc20Address: helpers.GenerateAddress().String(), Denom: "test", ContractOwner: types.OWNER_MODULE}, expectPass: false},
		{msg: "Register token pair - invalid missing description ", title: "test", description: "", pair: types.TokenPair{Erc20Address: helpers.GenerateAddress().String(), Denom: "test", ContractOwner: types.OWNER_MODULE}, expectPass: false},
		// Invalid address
		{msg: "Register token pair - invalid address (no hex)", title: "test", description: "test desc", pair: types.TokenPair{Erc20Address: "0x5dCA2483280D9727c80b5518faC4556617fb19ZZ", Denom: "test", Enabled: true, ContractOwner: types.OWNER_MODULE}, expectPass: false},
		{msg: "Register token pair - invalid address (invalid length 1)", title: "test", description: "test desc", pair: types.TokenPair{Erc20Address: "0x5dCA2483280D9727c80b5518faC4556617fb19", Denom: "test", Enabled: true, ContractOwner: types.OWNER_MODULE}, expectPass: false},
		{msg: "Register token pair - invalid address (invalid length 2)", title: "test", description: "test desc", pair: types.TokenPair{Erc20Address: "0x5dCA2483280D9727c80b5518faC4556617fb194FFF", Denom: "test", Enabled: true, ContractOwner: types.OWNER_MODULE}, expectPass: false},
		{msg: "Register token pair - invalid address (invalid prefix)", title: "test", description: "test desc", pair: types.TokenPair{Erc20Address: "1x5dCA2483280D9727c80b5518faC4556617fb19F", Denom: "test", Enabled: true, ContractOwner: types.OWNER_MODULE}, expectPass: false},
	}

	for i, tc := range testCases {
		tx := types.NewRegisterERC20Proposal(tc.title, tc.description, tc.pair.Erc20Address, []string{"eth0xaE0c78230711E7173D30353F76936a7dD7306b81"})
