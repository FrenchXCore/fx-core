...
func (b *Backend) GetGasUsed(res *fxtypes.TxResult, price *big.Int, gas uint64) uint64 {
...
func (b *Backend) GetTxByEthHash(hash common.Hash) (*fxtypes.TxResult, error) {
	if b.indexer != nil {
...
func (b *Backend) GetTxByTxIndex(height int64, index uint) (*fxtypes.TxResult, error) {
	if b.indexer != nil {
...
func (b *Backend) queryTendermintTxIndexer(query string, txGetter func(*rpctypes.ParsedTxs) *rpctypes.ParsedTx) (*fxtypes.TxResult, error) {
